databaseChangeLog = {
	...
	changeSet(author: "dus73 (generated)", id: "1460056300751-1") {
		createTable(tableName: "alignment_stats") {
			...
			column(name: "median_tag_singletons", type: "float")

			column(name: "peak_file_path", type: "varchar(255)")

			column(name: "peak_mean", type: "float")

			column(name: "peak_mean_std", type: "float")

			column(name: "peak_median", type: "float")

			column(name: "peak_median_std", type: "float")

			column(name: "peak_pair_nos", type: "float")

			column(name: "peak_pair_wis", type: "float")
