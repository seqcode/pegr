...
<div class="fieldcontain ${hasErrors(bean: object, field: 'name', 'error')} required">
	<label for="name">Name<span class="required-indicator">*</span></label>
	<g:textField name="name" required="" value="${object?.name}"/>
</div>

<div class="fieldcontain ${hasErrors(bean: object, field: 'abHost', 'error')} required">
...
<div class="fieldcontain ${hasErrors(bean: object, field: 'target', 'error')} required">
...
<div class="fieldcontain ${hasErrors(bean: object, field: 'concentration', 'error')} required">
...
<div class="fieldcontain ${hasErrors(bean: object, field: 'immunogene', 'error')} ">
	<label for="immunogene">Immunogene</label>
	<g:textField name="immunogene" value="${object?.immunogene}"/>
</div>

<div class="fieldcontain ${hasErrors(bean: object, field: 'clonal', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: object, field: 'igType', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: object, field: 'company', 'error')} ">
...
<div class="fieldcontain ${hasErrors(bean: object, field: 'catalogNumber', 'error')} ">
	<label for="catalogNumber">Catalog Number</label>
	<g:textField name="catalogNumber" value="${object?.catalogNumber}"/>
</div>

<div class="fieldcontain ${hasErrors(bean: object, field: 'lotNumber', 'error')} ">
	<label for="lotNumber">Lot Number</label>
	<g:textField name="lotNumber" value="${object?.lotNumber}"/>
</div>

<div class="fieldcontain ${hasErrors(bean: object, field: 'externalId', 'error')} ">
	<label for="externalId">External ID</label>
	<g:textField name="externalId" value="${object?.externalId}"/>
</div>

<div class="fieldcontain ${hasErrors(bean: object, field: 'inventoryId', 'error')} ">
	<label for="inventoryId">Inventory ID</label>
	<g:textField name="inventoryId" value="${object?.inventoryId}"/>

</div>

<div class="fieldcontain ${hasErrors(bean: item, field: 'type', 'error')} ">
    <label>Type</label>
...
<div class="fieldcontain ${hasErrors(bean: item, field: 'notes', 'error')} ">
    <label>Notes</label>
