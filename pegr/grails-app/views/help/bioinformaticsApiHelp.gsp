  ...
  data: [{
        ...
        "experiments": [{
                ...
                "alignments": [{ "id": long,
                    ...
                    "mappedReadsR2": long,
                    "uniquelyMappedReadsR2": long,
                    "dedupUniquelyMappedReadsR2": long,
                    "mappedReadPct": float,
                    "uniquelyMappedPct": float,
                    "deduplicatedPct": float,
                    "mappedReadPct2": float,
                    "uniquelyMappedPct2": float,
                    "deduplicatedPct2": float,
                    "avgInsertSize": integer,
                    "stdDevInsertSize": float,
                    "medianInsertSize": float,
                    "modeInsertSize": float,
