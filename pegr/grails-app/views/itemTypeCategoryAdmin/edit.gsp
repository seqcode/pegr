...
<html>
    ...
    <body>
        ...
        <div id="edit-itemTypeCategory" class="content scaffold-edit" role="main">
            ...
            <g:form action="update" id="${this.itemTypeCategoryInstance.id}" method="PUT">
                <g:hiddenField name="version" value="${this.itemTypeCategoryInstance?.version}" />
                <fieldset class="form">
