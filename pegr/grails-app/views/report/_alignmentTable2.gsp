                ...
                <tr>
                    ...
                    <g:each in="${sample.experiments}" var="experiment" status="nExp">
                        ...
                        <g:each in="${experiment.analysisWorkflowRuns}" var="analysisWorkflowRun" status="nAli">
                            ...
                            <td class="text-right"><g:formatNumber number="${analysisWorkflowRun.mappedReadPct}" format="##.#%" /></td>
                            <td class="text-right"><g:formatNumber number="${analysisWorkflowRun.uniquelyMappedPct}" format="##.#%" /></td>
                            <td class="text-right"><g:formatNumber number="${analysisWorkflowRun.deduplicatedPct}" format="##.#%" /></td>
                            </tr>
                        </g:each>                    
                    </g:each>                    
            </g:each>              
