            ...
            <div class="well">
                <div class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li title="The Sample has been processed by the bioinformatics pipeline and reviewed by lab bioinformatician."><g:link params="[status:'COMPLETED']">COMPLETED</g:link></li>
                    <li title="The Sample has been processed by the bioinformatics pipeline and reviewed by lab bioinformatician and considered failed."><g:link params="[status:'FAILED']">FAILED</g:link></li>
