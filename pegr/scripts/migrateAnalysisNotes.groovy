...
SequenceAlignment.list().each { alignment ->
    migrateForAlignment(alignment, utilityService, alignmentService)
}


void migrateForAlignment(SequenceAlignment alignment, UtilityService utilityService, AlignmentStatsService alignmentService) {
