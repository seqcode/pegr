...
CREATE TABLE `protocol_item_types` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK69c2d8246f1bc2e5e8d02ada96db` (`item_type_id`,`protocol_id`),
  KEY `FKjw224bhrckc7lnuqc9r8p9y1g` (`protocol_id`),
  CONSTRAINT `FKb5ck29pggprrfleshlkhx5qr8` FOREIGN KEY (`item_type_id`) REFERENCES `item_type` (`id`),
  CONSTRAINT `FKjw224bhrckc7lnuqc9r8p9y1g` FOREIGN KEY (`protocol_id`) REFERENCES `protocol` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `sequence_run` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `version` bigint(20) NOT NULL,
  `run_num_alias` varchar(255) DEFAULT NULL,
...
-- Dump completed on 2020-02-03 16:30:30
